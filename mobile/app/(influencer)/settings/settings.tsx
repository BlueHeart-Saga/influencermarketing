// C:\Sagadevan\quickbox\mobile\app\(influencer)\settings\profile.tsx
...
const CATEGORY_OPTIONS = [
  ...
  "Gaming", "Music", "Sports", "Parenting", "Photography", "Art"
];
...
const InfluencerProfileSettings = () => {
  ...
  const pickProfilePicture = async () => {
    ...
    if (image) {
      setForm(prev => ({ ...prev, profile_picture: image }));
      setProfilePreview(image.uri);
    }
  };
  ...
  const canProceedStep2 = () => {
    return form.location.trim() !== "" && form.categories.length > 0;
  };
    ...
    try {
      ...
      if (completionResult?.isComplete) {
        setSuccessDialogConfig({
          ...
          onButtonClick: () => router.push('/(influencer)/settings/profile'),
        });
      } else {
        setSuccessDialogConfig({
          title: "Profile Saved",
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      setSuccessDialogConfig({
        ...
        message: "Your influencer profile has been permanently deleted.",
      ...
      case 2:
        return (
          <View style={styles.stepContent}>
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>Categories / Niches *</Text>
              <TouchableOpacity
        ...
        return (
          <View style={styles.stepContent}>
            {SOCIAL_PLATFORMS.map((platform) => (
              <View key={platform.name} style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  value={form.social_links[platform.name.toLowerCase()] || ""}
                  onChangeText={(text) => handleSocialChange(platform.name, text)}
                  keyboardType="url"
                  autoCapitalize="none"
                />
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TouchableOpacity style={styles.uploadButton} onPress={pickProfilePicture}>
                ...
                <Text style={styles.uploadButtonText}>
                  {form.profile_picture || profilePreview ? "Change Photo" : "Upload Photo"}
                </Text>
              </TouchableOpacity>
              ...
              {profilePreview && (
                <View style={styles.previewContainer}>
                  <Image source={{ uri: profilePreview }} style={styles.profilePreview} />
                </View>
              )}
            </View>
          ...
          <View style={styles.stepContent}>
            ...
            <View style={styles.reviewSection}>
              ...
              <View style={styles.reviewItem}>
                ...
                <Text style={styles.reviewValue}>{form.full_name}</Text>
              </View>
              <View style={styles.reviewItem}>
                <Text style={styles.reviewLabel}>Nickname:</Text>
                <Text style={styles.reviewValue}>{form.nickname || 'Not provided'}</Text>
              </View>
              <View style={styles.reviewItem}>
            ...
            <View style={styles.reviewSection}>
              <Text style={styles.reviewSectionTitle}>Profile Details</Text>
              <View style={styles.reviewItem}>
            ...
            {Object.keys(form.social_links).length > 0 && (
              <View style={styles.reviewSection}>
                <Text style={styles.reviewSectionTitle}>Social Media</Text>
                {Object.entries(form.social_links).map(([platform, url]) => (
                  url ? (
                    <View key={platform} style={styles.reviewItem}>
                      <Text style={styles.reviewLabel}>{platform}:</Text>
                      <Text style={styles.reviewValue} numberOfLines={1}>{url}</Text>
                    </View>
                  ) : null
                ))}
              </View>
        ...
        <View style={styles.header}>
          ...
          <View>
            <Text style={styles.title}>
              {isEditing ? "Update Profile" : "Create Influencer Profile"}
            </Text>
            <Text style={styles.subtitle}>
              {isEditing 
                ? "Update your information to connect with brands"
        ...
        {isEditing && (
          <View style={styles.actionButtons}>
            <TouchableOpacity
              ...
              onPress={() => router.push('/(influencer)/(tabs)/account/profile')}
            >
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>Select Your Niches</Text>
          ...
          <View style={styles.dialogOverlay}>
            <View style={[styles.dialogContent, styles.dialogDanger]}>
              ...
              <Text style={styles.dialogMessage}>
                Are you sure you want to delete your influencer profile?
              </Text>
              <Text style={styles.dialogWarning}>
                This action cannot be undone and will permanently delete all your data, including posts and collaborations.
              </Text>
              <View style={styles.dialogActions}>
                <TouchableOpacity
