// C:\Sagadevan\quickbox\mobile\app\(influencer)\(tabs)\campaigns\bookmarks.tsx
...
// Main Component
const BookmarkedCampaignsScreen = () => {
  ...
  const fetchCampaigns = async () => {
    try {
      ...
      setCampaigns(formattedCampaigns.filter((c: any) => c.user_bookmarked));
    } catch (error) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Bookmarked Campaigns</Text>
...
export default BookmarkedCampaignsScreen;