// C:\Sagadevan\quickbox\mobile\app\(influencer)\(tabs)\campaigns\likes.tsx
...
const LikedCampaignsScreen = () => {
  ...
  const fetchCampaigns = async () => {
    try {
      ...
      setCampaigns(formattedCampaigns.filter((c: any) => c.user_liked));
    } catch (error) {
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyTitle}>No Liked Campaigns</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Liked Campaigns</Text>
...
export default LikedCampaignsScreen;