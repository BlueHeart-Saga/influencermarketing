...
// ✅ Import our real list components
import AllUsersList from "./AllUsersList";
import BrandUsersList from "./BrandUsersList";
import InfluencerUsersList from "./InfluencerUsersList";

const renderScene = SceneMap({
    all: AllUsersList,
    brand: BrandUsersList,
    influencer: InfluencerUsersList,
});

const SUB_TAB_CONFIG = {
    all: { title: "All Users", icon: "people-outline", color: "#6366F1" },
    brand: { title: "Brands", icon: "business-outline", color: "#0f6eea" },
    influencer: { title: "Influencers", icon: "person-outline", color: "#10B981" },
};
