...
const SUB_TAB_CONFIG = {
    logo: { title: "Logo", icon: "image-outline", color: "#6366F1" },
    contact: { title: "Contact", icon: "mail-outline", color: "#F59E0B" },
    feedbacks: { title: "Feedbacks", icon: "chatbubble-ellipses-outline", color: "#10B981" },
};
