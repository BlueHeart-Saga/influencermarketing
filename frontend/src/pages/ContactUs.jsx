...
const [isMobile, setIsMobile] = useState(window.innerWidth <= BREAKPOINT);
  ...
  useEffect(() => {
  setPageTitle(
    "Contact Us – AI Influencer Marketing Platform",
    "Contact us to learn how our AI influencer marketing platform helps brands and creators collaborate, run campaigns, and grow with data-driven insights."
  );
}, []);
...
useEffect(() => {
  const handleResize = () => {
    ...
    // Auto-close left section when switching to desktop
    if (!mobile) {
      setShowLeft(false);
    }
  };
  ...
  useEffect(() => {
  const savedEmail = sessionStorage.getItem("contact_prefill_email");
  ...
  if (savedEmail) {
    ...
    sessionStorage.removeItem("contact_prefill_email");
  }
}, []);
...
const leftSectionStyle = {
  ...styles.leftSection,
  animation: isMobile ? "slideDown 0.35s ease" : "none",
};
...
{isMobile && (
  <div style={styles.mobileToggleWrapper}>
    <button
      style={styles.mobileToggleButton}
      onClick={() => setShowLeft(prev => !prev)}
    >
      {showLeft ? "▲ Hide contact info" : "▼ Show contact info"}
    </button>
  </div>
)}
  ...
  <div style={leftSectionStyle}>
        ...
        <div style={styles.squareImageWrapper}>
  <img
          ...
          <div style={styles.contactMethodsCard}>
            <div style={styles.contactMethod}>
              <div style={{...styles.methodIcon, backgroundColor: '#e3f2fd00'}}>
                <span style={styles.methodEmoji}><Mail size={28} color="#3B82F6" /></span>
              </div>
              <div style={styles.methodDetails}>
                <h4 style={styles.methodTitle}>MAIL</h4>
                <p style={styles.methodText}>support@brio.com</p>
              </div>
            </div>
            ...
            <div style={styles.contactMethod}>
              <div style={{...styles.methodIcon, backgroundColor: '#e8f5e900'}}>
                <span style={styles.methodEmoji}><Phone size={28} color="#3B82F6" /></span>
              </div>
              <div style={styles.methodDetails}>
            ...
            <div style={styles.contactMethod}>
              <div style={{...styles.methodIcon, backgroundColor: '#f3e5f500'}}>
                <span style={styles.methodEmoji}><MessageCircle size={28} color="#3B82F6" /></span>
              </div>
              <div style={styles.methodDetails}>
